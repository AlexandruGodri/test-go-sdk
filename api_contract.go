...
/*
ContractApiService Retrieve a Contract
Retrieves the attributes of user&#x27;s contract.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ContractApiContractsGetOpts - Optional Parameters:
...
type ContractApiContractsGetOpts struct { 
	Pretty optional.Bool
	Depth optional.Int32
	XContractNumber optional.Int32
}

func (a *ContractApiService) ContractsGet(ctx context.Context, localVarOptionals *ContractApiContractsGetOpts) (Contract, *http.Response, error) {
	var (
